		...
		faq: [
			{
				...
				answer:
					'Изучайте материалы в удобное для вас время и выполняйте практические задания. Каждый урок включает видео и текстовые материалы, а также задания для самостоятельной работы.'
			},
			{
				question: 'Какие навыки нужны для начала?',
				answer:
					'Базовые знания Python или JavaScript будут полезны, но не обязательны. Главное — это желание учиться и развиваться в области backend-разработки.'
			},
			{
				question: 'Как долго длится курс?',
				answer:
					'Курс длится 2 месяца, с гибким графиком обучения, что позволяет вам самостоятельно планировать свои занятия.'
			},
			{
				question: 'Какие практические задания будут?',
				answer:
					'Вы будете разрабатывать собственное REST API, оптимизировать существующие приложения, а также участвовать в групповых проектах для получения опыта работы в команде.'
			}
		]
	},
	{
		...
		faq: [
			{
				...
				answer:
					'Только интерес к дизайну и желание учиться. Вы сможете освоить необходимые навыки, даже если ранее не имели опыта в этой области.'
			},
			{
				question: 'Какие программы изучаются?',
				answer:
					'Основные инструменты: Figma и Sketch, которые являются стандартом в индустрии и широко используются для создания дизайна интерфейсов.'
			},
			{
				question: 'Какой опыт требуется?',
				answer:
					'Предыдущий опыт не обязателен, главное — желание учиться и развиваться. Мы поможем вам на каждом шаге.'
			},
			{
				question: 'Как проходит обучение?',
				answer:
					'Вы изучаете материалы в удобное для вас время и выполняете практические задания, которые помогут закрепить пройденный материал и развить ваши навыки.'
			}
		]
	},
	{
		...
		faq: [
			{
				question: 'Какие знания нужны для начала?',
				answer:
					'Знания Linux и базовые навыки программирования будут полезны. Мы поможем вам освоить необходимые навыки в ходе обучения.'
			},
			{
				question: 'Сколько времени длится курс?',
				answer:
					'Курс длится примерно 2-3 месяца, с гибким графиком обучения, что позволяет вам учиться в удобное время.'
			},
			{
				question: 'Какой опыт будет полезен?',
				answer:
					'Предыдущий опыт работы с серверами или программированием приветствуется, но не является обязательным для участия в курсе.'
			},
			{
				question: 'Как проходит обучение?',
				answer:
					'Вы изучаете материалы в удобное для вас время и выполняете практические задания, которые помогут закрепить пройденный материал.'
			}
		]
	},
	{
		...
		faq: [
			{
				...
				answer:
					'Базовые знания будут полезны, но не обязательны. Мы предлагаем все необходимые материалы для изучения.'
			},
			{
				question: 'Какие программы используются?',
				answer:
					'Вы будете работать с Android Studio и языком Kotlin, которые являются основными инструментами для разработки под Android.'
			},
			{
				question: 'Сколько времени займет курс?',
				answer:
					'Курс длится около 3 месяцев, в зависимости от вашего темпа обучения и уровня вовлеченности в процесс.'
			},
			{
				question: 'Что будет на практике?',
				answer:
					'Вы будете разрабатывать реальные приложения, которые можно будет публиковать в Google Play, а также работать над проектами с коллегами.'
			}
		]
	},
	{
		...
		faq: [
			{
				...
				answer:
					'Базовые навыки программирования будут полезны, но не обязательны. Мы предоставим все необходимые материалы для обучения.'
			},
			{
				question: 'Как долго длится курс?',
				answer:
					'Курс длится примерно 2-3 месяца при интенсивном обучении, в зависимости от вашего темпа и уровня вовлеченности.'
			},
			{
				question: 'Что включает в себя курс?',
				answer:
					'Курс охватывает все ключевые аспекты Java-разработки, включая основы, объекты, работа с базами данных и создание RESTful API.'
			},
			{
				question: 'Будут ли практические занятия?',
				answer:
					'Да, курс включает в себя множество практических заданий, которые помогут вам закрепить изученный материал и применить его на практике.'
			}
		]
	},
		...
		faq: [
			{
				question: 'Нужно ли знать программирование?',
				answer:
					'Да, базовые навыки программирования будут полезны. Мы рекомендуем пройти предварительный курс по основам программирования.'
			},
			{
				question: 'Какие проекты можно будет создавать?',
				answer:
					'Вы сможете разрабатывать драйверы, игры и высоконагруженные системы, что открывает множество возможностей для трудоустройства.'
			}
		]
	},
	{
		...
		faq: [
			{
				...
				answer:
					'Базовые навыки будут полезны, но не обязательны. Мы предоставим все необходимые материалы для обучения.'
			},
			{
				question: 'Какие программы используются?',
				answer:
					'Вы будете работать с Xcode и изучите язык Swift, что является стандартом для разработки под iOS.'
			}
		]
	},
	{
		...
		faq: [
			{
				question: 'Нужно ли знание программирования?',
				answer:
					'Нет, курс подходит для новичков. Мы предоставим все необходимые материалы для обучения.'
			},
			{
				question: 'Как долго длится курс?',
				answer:
					'Курс длится примерно 1-2 месяца в зависимости от вашего темпа обучения и уровня подготовки.'
			}
		]
	}
]
