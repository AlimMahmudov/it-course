          ...
          <div className={scss.review_block}>
            <div className={scss.review_box}>
              ...
              <div className={scss.review_boxt_text}>
                ...
                <h3>
                  С радостью оставляю положительный отзыв! Пройдя курс
                  &quot;UX/UI Designer с нуля&quot; я остался полностью доволен,
                  что мой выбор пал именно на данную школу. Если вы выберите
                  данную школу - вам обеспечена прокачка в выбранной вами
                  области. Всячески рекомендую и благодарю!
                </h3>
              </div>
